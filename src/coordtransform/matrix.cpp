																													...
																													template <class T> matrix<T>
																															...
																															matrix<T>::svd(matrix<T>& vc, valarray<T>& w)
																														{
																															...
																															for (i = 0; i < n; i++)
																															{
																																...
																																anorm = hanssoft::max(anorm, abs(w[i]) + abs(rv1[i]));
																															}
																																		...
																																		template <class T> inline matrix<T>
																																				...
																																				matrix<T>::hqr2(valarray<T>& d, valarray<T>& e, matrix<T>& v, bool eivec)
																																			{
																																				...
																																				for (i = 0; i < nn; i++)
																																				{
																																					...
																																					for (j = hanssoft::max(i - 1, 0); j < nn; j++)
																																						norm += abs(pm[i*nn + j]);
																																				}
																																					...
																																					else
																																					{
																																						...
																																						for (k = m; k <= n - 1; k++)
																																						{
																																							...
																																							if (s != T(0))
																																							{
																																								...
																																								for (i = 0; i <= hanssoft::min(n, k + 3); i++)
																																								{
																																					...
																																					else if (q < T(0))
																																					{
																																						...
																																						for (i = n - 2; i >= 0; i--)
																																						{
																																							...
																																							else
																																							{
																																								...
																																								t = hanssoft::max(abs(pm[i*nn + n - 1]), abs(pm[i*nn + n]));
																																								if ((epsilon(t) * t) * t > T(1))
																																									for (j = i; j <= n; j++)
																																									{
																																										pm[j*nn + n - 1] /= t;
																																				...
																																				if (eivec)
																																				{
																																					...
																																					for (j = nn - 1; j >= low; j--)
																																						...
																																						{
																																							z = T(0);
																																							for (k = low; k <= hanssoft::min(j, high); k++)
