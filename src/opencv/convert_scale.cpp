...
static inline void v_load_expand_from_u8_f32(const uchar* src,
		const v_float32x4 &v_scale, const v_float32x4 &v_shift, v_float32x4 &a,
		v_float32x4 &b)
{
...
static inline void v_load_expand_from_s8_f32(const schar* src,
		const v_float32x4 &v_scale, const v_float32x4 &v_shift, v_float32x4 &a,
		v_float32x4 &b)
{
...
static inline void v_load_expand_from_u16_f32(const ushort* src,
		const v_float32x4 &v_scale, const v_float32x4 &v_shift, v_float32x4 &a,
		v_float32x4 &b)
{
	v_uint32x4 v_src0, v_src1;
...
static inline void v_load_expand_from_s16_f32(const short* src,
		const v_float32x4 &v_scale, const v_float32x4 &v_shift, v_float32x4 &a,
		v_float32x4 &b)
{
	v_int32x4 v_src0, v_src1;
...
static inline void v_load_expand_from_s32_f32(const int* src,
		const v_float32x4 &v_scale, const v_float32x4 &v_shift, v_float32x4 &a,
		v_float32x4 &b)
{
...
{
	int operator ()(const uchar * src, uchar * dst, int width, float scale,
			float shift) const
	{
		int x = 0;
		if (hasSIMD128())
		{
			...
			for (; x <= width - cWidth * 2; x += cWidth * 2)
			{
				...
				v_load_expand_from_u8_f32(src + x, v_scale, v_shift, v_dst_0,
						v_dst_1);
				v_load_expand_from_u8_f32(src + x + cWidth, v_scale, v_shift,
						v_dst_2, v_dst_3);
...
{
	int operator ()(const schar * src, uchar * dst, int width, float scale,
			float shift) const
	{
		int x = 0;
		if (hasSIMD128())
		{
			...
			{
				v_float32x4 v_dst_0, v_dst_1, v_dst_2, v_dst_3;
				v_load_expand_from_s8_f32(src + x, v_scale, v_shift, v_dst_0,
						v_dst_1);
				v_load_expand_from_s8_f32(src + x + cWidth, v_scale, v_shift,
						v_dst_2, v_dst_3);
				v_dst_0 = v_abs(v_dst_0);
				v_dst_1 = v_abs(v_dst_1);
				v_dst_2 = v_abs(v_dst_2);
				...
				v_uint16x8 v_dsti_0 = v_pack_u(v_round(v_dst_0),
						v_round(v_dst_1));
				v_uint16x8 v_dsti_1 = v_pack_u(v_round(v_dst_2),
						v_round(v_dst_3));
...
{
	int operator ()(const ushort * src, uchar * dst, int width, float scale,
			float shift) const
	{
		int x = 0;
		if (hasSIMD128())
		{
			...
			for (; x <= width - cWidth; x += cWidth)
			{
				...
				v_load_expand_from_u16_f32(src + x, v_scale, v_shift, v_dst0,
						v_dst1);
				v_dst0 = v_abs(v_dst0);
				v_dst1 = v_abs(v_dst1);
...
{
	int operator ()(const short * src, uchar * dst, int width, float scale,
			float shift) const
	{
		int x = 0;
		if (hasSIMD128())
		{
			...
			{
				v_float32x4 v_dst0, v_dst1;
				v_load_expand_from_s16_f32(src + x, v_scale, v_shift, v_dst0,
						v_dst1);
				v_dst0 = v_abs(v_dst0);
				v_dst1 = v_abs(v_dst1);
...
{
	int operator ()(const int * src, uchar * dst, int width, float scale,
			float shift) const
	{
		int x = 0;
		v_float32x4 v_shift = v_setall_f32(shift);
...
{
	int operator ()(const float * src, uchar * dst, int width, float scale,
			float shift) const
	{
		int x = 0;
		v_float32x4 v_shift = v_setall_f32(shift);
...
{
	int operator ()(const double * src, uchar * dst, int width, float scale,
			float shift) const
	{
		int x = 0;
		...
		if (hasSIMD128())
		{
			...
			for (; x <= width - cWidth * 4; x += cWidth * 4)
			{
				...
				v_recombine(v_cvt_f32(v_load(src + x)),
						v_cvt_f32(v_load(src + x + cWidth)), v_src1, v_dummy);
				v_recombine(v_cvt_f32(v_load(src + x + cWidth * 2)),
						v_cvt_f32(v_load(src + x + cWidth * 3)), v_src2,
						v_dummy);
...
template<typename T, typename DT, typename WT> static void cvtScaleAbs_(
		const T* src, size_t sstep, DT* dst, size_t dstep, Size size, WT scale,
		WT shift)
{
	sstep /= sizeof(src[0]);
	dstep /= sizeof(dst[0]);
...
struct cvtScale_SIMD<uchar, uchar, float>
{
			...
			float shift) const
	{
		...
		if (hasSIMD128())
		{
			v_float32x4 v_shift = v_setall_f32(shift), v_scale = v_setall_f32(
					scale);
			int cWidth = v_uint16x8::nlanes;
			for (; x <= width - cWidth; x += cWidth)
			{
				v_float32x4 v_src1, v_src2;
				v_load_expand_from_u8_f32(src + x, v_scale, v_shift, v_src1,
						v_src2);
...
{
	int operator ()(const uchar * src, schar * dst, int width, float scale,
			float shift) const
	{
		int x = 0;
		if (hasSIMD128())
...
{
	int operator ()(const uchar * src, ushort * dst, int width, float scale,
			float shift) const
	{
		int x = 0;
#if CV_TRY_SSE4_1
...
{
	int operator ()(const uchar * src, short * dst, int width, float scale,
			float shift) const
	{
		int x = 0;
		if (hasSIMD128())
...
{
	int operator ()(const uchar * src, int * dst, int width, float scale,
			float shift) const
	{
		int x = 0;
		if (hasSIMD128())
...
{
	int operator ()(const uchar * src, float * dst, int width, float scale,
			float shift) const
	{
		int x = 0;
		if (hasSIMD128())
...
struct cvtScale_SIMD<schar, uchar, float>
{
			...
			float shift) const
	{
		...
		if (hasSIMD128())
		{
			...
			{
				v_float32x4 v_src1, v_src2;
				v_load_expand_from_s8_f32(src + x, v_scale, v_shift, v_src1,
						v_src2);
...
{
	int operator ()(const schar * src, schar * dst, int width, float scale,
			float shift) const
	{
		int x = 0;
		if (hasSIMD128())
...
{
	int operator ()(const schar * src, ushort * dst, int width, float scale,
			float shift) const
	{
		int x = 0;
#if CV_TRY_SSE4_1
...
{
	int operator ()(const schar * src, short * dst, int width, float scale,
			float shift) const
	{
		int x = 0;
		if (hasSIMD128())
...
{
	int operator ()(const schar * src, int * dst, int width, float scale,
			float shift) const
	{
		int x = 0;
		if (hasSIMD128())
...
{
	int operator ()(const schar * src, float * dst, int width, float scale,
			float shift) const
	{
		int x = 0;
		if (hasSIMD128())
...
struct cvtScale_SIMD<ushort, uchar, float>
{
			...
			float shift) const
	{
		...
		if (hasSIMD128())
		{
			...
			{
				v_float32x4 v_src1, v_src2;
				v_load_expand_from_u16_f32(src + x, v_scale, v_shift, v_src1,
						v_src2);
...
{
	int operator ()(const ushort * src, schar * dst, int width, float scale,
			float shift) const
	{
		int x = 0;
		if (hasSIMD128())
...
{
	int operator ()(const ushort * src, ushort * dst, int width, float scale,
			float shift) const
	{
		int x = 0;
#if CV_TRY_SSE4_1
...
{
	int operator ()(const ushort * src, short * dst, int width, float scale,
			float shift) const
	{
		int x = 0;
		if (hasSIMD128())
...
{
	int operator ()(const ushort * src, int * dst, int width, float scale,
			float shift) const
	{
		int x = 0;
		if (hasSIMD128())
...
{
	int operator ()(const ushort * src, float * dst, int width, float scale,
			float shift) const
	{
		int x = 0;
		if (hasSIMD128())
...
struct cvtScale_SIMD<short, uchar, float>
{
			...
			float shift) const
	{
		...
		if (hasSIMD128())
		{
			...
			{
				v_float32x4 v_src1, v_src2;
				v_load_expand_from_s16_f32(src + x, v_scale, v_shift, v_src1,
						v_src2);
...
{
	int operator ()(const short * src, schar * dst, int width, float scale,
			float shift) const
	{
		int x = 0;
		if (hasSIMD128())
...
{
	int operator ()(const short * src, ushort * dst, int width, float scale,
			float shift) const
	{
		int x = 0;
#if CV_TRY_SSE4_1
...
{
	int operator ()(const short * src, short * dst, int width, float scale,
			float shift) const
	{
		int x = 0;
		if (hasSIMD128())
...
{
	int operator ()(const short * src, float * dst, int width, float scale,
			float shift) const
	{
		int x = 0;
		if (hasSIMD128())
...
struct cvtScale_SIMD<int, uchar, float>
{
			...
			float shift) const
	{
		...
		if (hasSIMD128())
		{
			...
			{
				v_float32x4 v_src1, v_src2;
				v_load_expand_from_s32_f32(src + x, v_scale, v_shift, v_src1,
						v_src2);
...
{
	int operator ()(const int * src, schar * dst, int width, float scale,
			float shift) const
	{
		int x = 0;
		if (hasSIMD128())
...
{
	int operator ()(const int * src, ushort * dst, int width, float scale,
			float shift) const
	{
		int x = 0;
#if CV_TRY_SSE4_1
...
{
	int operator ()(const int * src, short * dst, int width, float scale,
			float shift) const
	{
		int x = 0;
		if (hasSIMD128())
...
{
	int operator ()(const int * src, int * dst, int width, double scale,
			double shift) const
	{
		int x = 0;
		if (hasSIMD128())
		{
			v_float64x2 v_shift = v_setall_f64(shift), v_scale = v_setall_f64(
					scale);
			int cWidth = v_int32x4::nlanes;
			for (; x <= width - cWidth; x += cWidth)
			{
				double v_srcbuf[] =
				{	(double) src[x], (double) src[x + 1],
					(double) src[x + 2], (double) src[x + 3]};
				v_float64x2 v_src1 = v_shift + v_scale * v_load(v_srcbuf);
				v_float64x2 v_src2 = v_shift + v_scale * v_load(v_srcbuf + 2);
				v_store(dst + x,
						v_combine_low(v_round(v_src1), v_round(v_src2)));
			}
		}
		return x;
	}
...
{
	int operator ()(const int * src, float * dst, int width, double scale,
			double shift) const
	{
		int x = 0;
		if (hasSIMD128())
		{
			...
			for (; x <= width - cWidth; x += cWidth)
			{
				...
				v_float64x2 v_src2 = v_shift + v_scale * v_load(v_srcbuf + 2);
				v_store(dst + x,
						v_combine_low(v_cvt_f32(v_src1), v_cvt_f32(v_src2)));
			}
		}
		return x;
	}
			...
			float shift) const
	{
		...
		if (hasSIMD128())
		{
			...
			for (; x <= width - cWidth * 2; x += cWidth * 2)
			{
				...
				v_float32x4 v_dst2 = v_shift
				+ v_scale * v_load(src + x + cWidth);
...
{
	int operator ()(const float * src, schar * dst, int width, float scale,
			float shift) const
	{
		int x = 0;
		if (hasSIMD128())
...
{
	int operator ()(const float * src, ushort * dst, int width, float scale,
			float shift) const
	{
		int x = 0;
#if CV_TRY_SSE4_1
...
{
	int operator ()(const float * src, short * dst, int width, float scale,
			float shift) const
	{
		int x = 0;
		if (hasSIMD128())
...
{
	int operator ()(const float * src, int * dst, int width, float scale,
			float shift) const
	{
		int x = 0;
		if (hasSIMD128())
...
{
	int operator ()(const float * src, float * dst, int width, float scale,
			float shift) const
	{
		int x = 0;
		if (hasSIMD128())
...
static inline void v_load_scale_shift(const double* src,
		const v_float64x2& v_scale, const v_float64x2 &v_shift,
		v_float32x4& v_dst1, v_float32x4 &v_dst2)
{
	int cWidth = v_float64x2::nlanes;
...
static inline void v_store_scale_shift_s32_to_f64(double *dst,
		const v_float64x2 &v_scale, const v_float64x2 &v_shift,
		const v_int32x4 &v1, const v_int32x4 &v2)
{
...
static inline void v_store_scale_shift_f32_to_f64(double *dst,
		const v_float64x2 &v_scale, const v_float64x2 &v_shift,
		const v_float32x4 &v1, const v_float32x4 &v2)
{
	v_float64x2 v_dst1 = v_shift + v_scale * v_cvt_f64(v1);
	v_float64x2 v_dst2 = v_shift + v_scale * v_cvt_f64_high(v1);
	v_float64x2 v_dst3 = v_shift + v_scale * v_cvt_f64(v2);
...
struct cvtScale_SIMD<double, uchar, float>
{
			...
			float shift) const
	{
		...
		if (hasSIMD128())
		{
			v_float64x2 v_shift = v_setall_f64((double) shift), v_scale =
			v_setall_f64((double) scale);
			int cWidth = v_float64x2::nlanes;
			for (; x <= width - cWidth * 4; x += cWidth * 4)
			{
				v_float32x4 v_dst1, v_dst2;
				v_load_scale_shift(src + x, v_scale, v_shift, v_dst1, v_dst2);
				v_pack_u_store(dst + x,
						v_pack(v_round(v_dst1), v_round(v_dst2)));
			}
		}
		return x;
	}
...
{
	int operator ()(const double * src, schar * dst, int width, float scale,
			float shift) const
	{
		int x = 0;
		if (hasSIMD128())
...
{
	int operator ()(const double * src, ushort * dst, int width, float scale,
			float shift) const
	{
		int x = 0;
#if CV_TRY_SSE4_1
...
{
	int operator ()(const double * src, short * dst, int width, float scale,
			float shift) const
	{
		int x = 0;
		if (hasSIMD128())
...
{
	int operator ()(const double * src, int * dst, int width, double scale,
			double shift) const
	{
		int x = 0;
		if (hasSIMD128())
...
{
	int operator ()(const double * src, float * dst, int width, double scale,
			double shift) const
	{
		int x = 0;
		if (hasSIMD128())
...
{
	int operator ()(const uchar * src, double * dst, int width, double scale,
			double shift) const
	{
		int x = 0;
		if (hasSIMD128())
		{
			...
			for (; x <= width - cWidth * 4; x += cWidth * 4)
			{
				...
				v_store_scale_shift_s32_to_f64(dst + x, v_scale, v_shift,
						v_reinterpret_as_s32(v_src1),
						v_reinterpret_as_s32(v_src2));
			}
		}
		return x;
	}
...
{
	int operator ()(const schar * src, double * dst, int width, double scale,
			double shift) const
	{
		int x = 0;
		if (hasSIMD128())
...
{
	int operator ()(const ushort * src, double * dst, int width, double scale,
			double shift) const
	{
		int x = 0;
		if (hasSIMD128())
...
{
	int operator ()(const short * src, double * dst, int width, double scale,
			double shift) const
	{
		int x = 0;
		if (hasSIMD128())
...
{
	int operator ()(const int * src, double * dst, int width, double scale,
			double shift) const
	{
		int x = 0;
		if (hasSIMD128())
...
{
	int operator ()(const float * src, double * dst, int width, double scale,
			double shift) const
	{
		int x = 0;
		if (hasSIMD128())
		{
			...
			for (; x <= width - cWidth * 2; x += cWidth * 2)
			{
				...
				v_store_scale_shift_f32_to_f64(dst + x, v_scale, v_shift,
						v_src1, v_src2);
			}
		}
		return x;
...
{
	int operator ()(const double * src, double * dst, int width, double scale,
			double shift) const
	{
		int x = 0;
		if (hasSIMD128())
...
template<typename T, typename DT, typename WT> static void cvtScale_(
		const T* src, size_t sstep, DT* dst, size_t dstep, Size size, WT scale,
		WT shift)
{
	sstep /= sizeof(src[0]);
...
template<> void cvtScale_<short, int, float>(const short* src, size_t sstep,
		int* dst, size_t dstep, Size size, float scale, float shift)
{
	sstep /= sizeof(src[0]);
	dstep /= sizeof(dst[0]);
...
static BinaryFunc getCvtScaleAbsFunc(int depth)
{
	...
	{ (BinaryFunc) cvtScaleAbs8u, (BinaryFunc) cvtScaleAbs8s8u,
...
BinaryFunc getConvertScaleFunc(int sdepth, int ddepth)
{
	...
	{
	{ (BinaryFunc) GET_OPTIMIZED(cvtScale8u), (BinaryFunc) GET_OPTIMIZED(
			cvtScale8s8u), (BinaryFunc) GET_OPTIMIZED(cvtScale16u8u),
			(BinaryFunc) GET_OPTIMIZED(cvtScale16s8u),
			(BinaryFunc) GET_OPTIMIZED(cvtScale32s8u),
			(BinaryFunc) GET_OPTIMIZED(cvtScale32f8u),
			(BinaryFunc) cvtScale64f8u, 0 },
	{ (BinaryFunc) GET_OPTIMIZED(cvtScale8u8s), (BinaryFunc) GET_OPTIMIZED(
			cvtScale8s), (BinaryFunc) GET_OPTIMIZED(cvtScale16u8s),
			(BinaryFunc) GET_OPTIMIZED(cvtScale16s8s),
			(BinaryFunc) GET_OPTIMIZED(cvtScale32s8s),
			(BinaryFunc) GET_OPTIMIZED(cvtScale32f8s),
			(BinaryFunc) cvtScale64f8s, 0 },
	{ (BinaryFunc) GET_OPTIMIZED(cvtScale8u16u), (BinaryFunc) GET_OPTIMIZED(
			cvtScale8s16u), (BinaryFunc) GET_OPTIMIZED(cvtScale16u),
			(BinaryFunc) GET_OPTIMIZED(cvtScale16s16u),
			(BinaryFunc) GET_OPTIMIZED(cvtScale32s16u),
			(BinaryFunc) GET_OPTIMIZED(cvtScale32f16u),
			(BinaryFunc) cvtScale64f16u, 0 },
	{ (BinaryFunc) GET_OPTIMIZED(cvtScale8u16s), (BinaryFunc) GET_OPTIMIZED(
			cvtScale8s16s), (BinaryFunc) GET_OPTIMIZED(cvtScale16u16s),
			(BinaryFunc) GET_OPTIMIZED(cvtScale16s), (BinaryFunc) GET_OPTIMIZED(
					cvtScale32s16s), (BinaryFunc) GET_OPTIMIZED(cvtScale32f16s),
			(BinaryFunc) cvtScale64f16s, 0 },
	{ (BinaryFunc) GET_OPTIMIZED(cvtScale8u32s), (BinaryFunc) GET_OPTIMIZED(
			cvtScale8s32s), (BinaryFunc) GET_OPTIMIZED(cvtScale16u32s),
			(BinaryFunc) GET_OPTIMIZED(cvtScale16s32s),
			(BinaryFunc) GET_OPTIMIZED(cvtScale32s), (BinaryFunc) GET_OPTIMIZED(
					cvtScale32f32s), (BinaryFunc) cvtScale64f32s, 0 },
	{ (BinaryFunc) GET_OPTIMIZED(cvtScale8u32f), (BinaryFunc) GET_OPTIMIZED(
			cvtScale8s32f), (BinaryFunc) GET_OPTIMIZED(cvtScale16u32f),
			(BinaryFunc) GET_OPTIMIZED(cvtScale16s32f),
			(BinaryFunc) GET_OPTIMIZED(cvtScale32s32f),
			(BinaryFunc) GET_OPTIMIZED(cvtScale32f),
			(BinaryFunc) cvtScale64f32f, 0 },
	{ (BinaryFunc) cvtScale8u64f, (BinaryFunc) cvtScale8s64f,
			(BinaryFunc) cvtScale16u64f, (BinaryFunc) cvtScale16s64f,
			(BinaryFunc) cvtScale32s64f, (BinaryFunc) cvtScale32f64f,
...
static bool ocl_convertScaleAbs( InputArray _src, OutputArray _dst, double alpha, double beta )
{
	...
	size_t globalsize[2] =
	{	(size_t)src.cols * cn / kercn, ((size_t)src.rows + rowsPerWI - 1) / rowsPerWI};
...
void cv::convertScaleAbs(InputArray _src, OutputArray _dst, double alpha,
	double beta)
{
		...
		double scale, double delta )
{
	...
	else if (src.channels() <= 4)
	{
		...
		size_t globalsize[2] =
		{	(size_t)src.cols, ((size_t)src.rows + rowsPerWI - 1) / rowsPerWI};
		return k.run(2, globalsize, NULL, false);
	}
	else
	{
